        ...
        copy: {
            web: {
                files: [
                    ...
                    {expand: true, src: ['<%= configPath.dev %>' + '/vendor/libs/require/require.js'], dest: '<%= configPath.public_temp_web %>', flatten: true},
            ...
            mobile: {
                files: [
                    ...
                    {expand: true, src: ['<%= configPath.dev %>' + '/vendor/libs/require/require.js'], dest: '<%= configPath.public_temp_mobile %>', flatten: true},
